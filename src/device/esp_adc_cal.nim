...
type
  esp_adc_cal_characteristics_t* {.bycopy.} = object
    adc_num*: adc_unit_t       ## *< ADC number
    atten*: adc_atten_t        ## *< ADC attenuation
    bit_width*: adc_bits_width_t ## *< ADC bit width
    coeff_a*: uint32         ## *< Gradient of ADC-Voltage curve
    coeff_b*: uint32         ## *< Offset of ADC-Voltage curve
    vref*: uint32            ## *< Vref used by lookup table
    low_curve*: ptr uint32    ## *< Pointer to low Vref curve of lookup table (NULL if unused)
    high_curve*: ptr uint32   ## *< Pointer to high Vref curve of lookup table (NULL if unused)
    version*: uint8          ## *< ADC Calibration
...
proc esp_adc_cal_check_efuse*(value_type: esp_adc_cal_value_t): esp_err_t {.
    importc: "esp_adc_cal_check_efuse".}
## *
...
proc esp_adc_cal_characterize*(adc_num: adc_unit_t; atten: adc_atten_t;
    ...
    importc: "esp_adc_cal_characterize".}
## *
...
proc esp_adc_cal_raw_to_voltage*(adc_reading: uint32;
                                chars: ptr esp_adc_cal_characteristics_t): uint32 {.
    importc: "esp_adc_cal_raw_to_voltage".}
## *
...
proc esp_adc_cal_get_voltage*(channel: adc_channel_t;
                             ...
                             voltage: ptr uint32): esp_err_t {.
    importc: "esp_adc_cal_get_voltage".}
